...
```powershell
git clone [https://github.com/Srinidhi3239/hiver-support-agent.git](https://github.com/Srinidhi3239/hiver-support-agent.git)
cd hiver-support-agent
python -m venv .venv
.venv\Scripts\Activate.ps1
pip install -r requirements.txt
Configure Environment Variable (30 sec)Create a .env file in the root directory:Code snippetGROQ_API_KEY=your_groq_api_key_here
Run Evaluation Benchmark (1 min)PowerShellpython src/evaluate.py
This runs the comparative evaluation across the Golden Set (data/golden_set.jsonl) against two baselines, invokes the LLM-as-a-judge auditor, and updates eval_results/benchmark_summary.json.Run Live Verification Tests (30 sec)PowerShellpython demo.py
